...
/*}}}*/
/*{{{  Insert HEADER*/
typedef struct SF_F_ALOG_snglmath tSF_F_ALOG_snglmath;
typedef struct SF_F_ALOG10_snglmath tSF_F_ALOG10_snglmath;
typedef struct SF_F_EXP_snglmath tSF_F_EXP_snglmath;
typedef struct SF_F_TAN_snglmath tSF_F_TAN_snglmath;
typedef struct SF_F_SIN_snglmath tSF_F_SIN_snglmath;
typedef struct SF_F_ASIN_snglmath tSF_F_ASIN_snglmath;
typedef struct SF_F_COS_snglmath tSF_F_COS_snglmath;
typedef struct SF_F_ACOS_snglmath tSF_F_ACOS_snglmath;
typedef struct SF_F_SINH_snglmath tSF_F_SINH_snglmath;
typedef struct SF_F_COSH_snglmath tSF_F_COSH_snglmath;
typedef struct SF_F_TANH_snglmath tSF_F_TANH_snglmath;
typedef struct SF_F_ATAN_snglmath tSF_F_ATAN_snglmath;
typedef struct SF_F_ATAN2_snglmath tSF_F_ATAN2_snglmath;
typedef struct SF_F_RAN_snglmath tSF_F_RAN_snglmath;
typedef struct SF_F_POWER_snglmath tSF_F_POWER_snglmath;
REAL32 F_POWER_snglmath(REAL32 x_109,REAL32 y_110);
struct SF_F_ALOG_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_ALOG10_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_EXP_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_TAN_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_SIN_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_ASIN_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_COS_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_ACOS_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_SINH_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_COSH_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_TANH_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_ATAN_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_ATAN2_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_RAN_snglmath
{
  tHeader _Header;
  void *Chain;
};
struct SF_F_POWER_snglmath
{
  tHeader _Header;
  void *Chain;
};
...
static struct Prototypes Table[] =
{
  {"REAL32 F_ALOG_snglmath(REAL32 x_51);",NULL,0},
  {"REAL32 F_ALOG10_snglmath(REAL32 x_55);",NULL,0},
  {"REAL32 F_EXP_snglmath(REAL32 x_59);",NULL,0},
  {"REAL32 F_TAN_snglmath(REAL32 x_63);",NULL,0},
  {"REAL32 F_SIN_snglmath(REAL32 x_67);",NULL,0},
  {"REAL32 F_ASIN_snglmath(REAL32 x_71);",NULL,0},
  {"REAL32 F_COS_snglmath(REAL32 x_75);",NULL,0},
  {"REAL32 F_ACOS_snglmath(REAL32 x_79);",NULL,0},
  {"REAL32 F_SINH_snglmath(REAL32 x_83);",NULL,0},
  {"REAL32 F_COSH_snglmath(REAL32 x_87);",NULL,0},
  {"REAL32 F_TANH_snglmath(REAL32 x_91);",NULL,0},
  {"REAL32 F_ATAN_snglmath(REAL32 x_95);",NULL,0},
  {"REAL32 F_ATAN2_snglmath(REAL32 x_99,REAL32 y_100);",NULL,0},
  {"void F_RAN_snglmath(INT32 x_104,REAL32 *Param0,INT32 *Param1);",NULL,0},
  {"REAL32 F_POWER_snglmath(REAL32 x_109,REAL32 y_110);",NULL,0},
...
int main(int argc, char**argv)
{
  ...
  else
  {
    int arg;
    int i;
    fprintf(f,"#ifndef __snglmath_INCLUDES__\n");
    fprintf(f,"#define __snglmath_INCLUDES__\n");
...
/*{{{  Insert CODE*/
#include <math.h>
REAL32 F_ALOG_snglmath(REAL32 x_51)
{
  REAL32 _Result;
  tSF_F_ALOG_snglmath SF;
  tSF_F_ALOG_snglmath *FP = &SF;
  {
    REAL32 r_52;
    if ((x_51 >= 0.0e+00))
    {
      r_52 = (REAL32)log(x_51);
    }
    else
    {
      SETERR(MSG_IF);
...
REAL32 F_ALOG10_snglmath(REAL32 x_55)
{
  REAL32 _Result;
  tSF_F_ALOG10_snglmath SF;
  tSF_F_ALOG10_snglmath *FP = &SF;
  {
    REAL32 r_56;
    if ((x_55 >= 0.0e+00))
    {
      r_56 = (REAL32)log10(x_55);
    }
    else
    {
      SETERR(MSG_IF);
...
REAL32 F_EXP_snglmath(REAL32 x_59)
{
  REAL32 _Result;
  tSF_F_EXP_snglmath SF;
  tSF_F_EXP_snglmath *FP = &SF;
  {
    REAL32 r_60;
    r_60 = (REAL32)exp(x_59);
    _Result = r_60;
  }
  return _Result;
}

REAL32 F_TAN_snglmath(REAL32 x_63)
{
  REAL32 _Result;
  tSF_F_TAN_snglmath SF;
  tSF_F_TAN_snglmath *FP = &SF;
  {
    REAL32 r_64;
    r_64 = (REAL32)tan(x_63);
    _Result = r_64;
  }
  return _Result;
}

REAL32 F_SIN_snglmath(REAL32 x_67)
{
  REAL32 _Result;
  tSF_F_SIN_snglmath SF;
  tSF_F_SIN_snglmath *FP = &SF;
  {
    REAL32 r_68;
    r_68 = (REAL32)sin(x_67);
    _Result = r_68;
  }
  return _Result;
}

REAL32 F_ASIN_snglmath(REAL32 x_71)
{
  REAL32 _Result;
  tSF_F_ASIN_snglmath SF;
  tSF_F_ASIN_snglmath *FP = &SF;
  {
    REAL32 r_72;
    if (((x_71 >= -1.0e+00) && (x_71 <= 1.0e+00)))
    {
      r_72 = (REAL32)asin(x_71);
    }
    else
    {
      SETERR(MSG_IF);
...
REAL32 F_COS_snglmath(REAL32 x_75)
{
  REAL32 _Result;
  tSF_F_COS_snglmath SF;
  tSF_F_COS_snglmath *FP = &SF;
  {
    REAL32 r_76;
    r_76 = (REAL32)cos(x_75);
    _Result = r_76;
  }
  return _Result;
}

REAL32 F_ACOS_snglmath(REAL32 x_79)
{
  REAL32 _Result;
  tSF_F_ACOS_snglmath SF;
  tSF_F_ACOS_snglmath *FP = &SF;
  {
    REAL32 r_80;
    if (((x_79 >= -1.0e+00) && (x_79 <= 1.0e+00)))
    {
      r_80 = (REAL32)acos(x_79);
    }
    else
    {
      SETERR(MSG_IF);
...
REAL32 F_SINH_snglmath(REAL32 x_83)
{
  REAL32 _Result;
  tSF_F_SINH_snglmath SF;
  tSF_F_SINH_snglmath *FP = &SF;
  {
    REAL32 r_84;
    r_84 = (REAL32)sinh(x_83);
    _Result = r_84;
  }
  return _Result;
}

REAL32 F_COSH_snglmath(REAL32 x_87)
{
  REAL32 _Result;
  tSF_F_COSH_snglmath SF;
  tSF_F_COSH_snglmath *FP = &SF;
  {
    REAL32 r_88;
    r_88 = (REAL32)cosh(x_87);
    _Result = r_88;
  }
  return _Result;
}

REAL32 F_TANH_snglmath(REAL32 x_91)
{
  REAL32 _Result;
  tSF_F_TANH_snglmath SF;
  tSF_F_TANH_snglmath *FP = &SF;
  {
    REAL32 r_92;
    r_92 = (REAL32)tanh(x_91);
    _Result = r_92;
  }
  return _Result;
}

REAL32 F_ATAN_snglmath(REAL32 x_95)
{
  REAL32 _Result;
  tSF_F_ATAN_snglmath SF;
  tSF_F_ATAN_snglmath *FP = &SF;
  {
    REAL32 r_96;
    if (((x_95 >= -1.0e+00) && (x_95 <= 1.0e+00)))
    {
      r_96 = (REAL32)atan(x_95);
    }
    else
    {
      SETERR(MSG_IF);
...
REAL32 F_ATAN2_snglmath(REAL32 x_99,REAL32 y_100)
{
  REAL32 _Result;
  tSF_F_ATAN2_snglmath SF;
  tSF_F_ATAN2_snglmath *FP = &SF;
  {
    REAL32 r_101;
    if ((y_100 <= x_99))
    {
      r_101 = (REAL32)atan2(y_100,x_99);
    }
    else
    {
      SETERR(MSG_IF);
...
void F_RAN_snglmath(INT32 x_104,REAL32 *Param0,INT32 *Param1)
{
  tSF_F_RAN_snglmath SF;
  tSF_F_RAN_snglmath *FP = &SF;
  {
    REAL32 r_105;
    INT32 i_106;
    {
      i_106 = (INT32) rand();
      #if (OS == SUNOS)
      r_105 = (REAL32)drand48();
      #else
      r_105 = ((REAL32)i_106) / ((REAL32)RAND_MAX);
      #endif
    }
    *Param0=r_105;
    *Param1=i_106;
...
{
  REAL32 _Result;
  tSF_F_POWER_snglmath SF;
  tSF_F_POWER_snglmath *FP = &SF;
  {
    REAL32 r_111;
    r_111 = (REAL32)pow(x_109,y_110);
    _Result = r_111;
  }
  return _Result;
}
