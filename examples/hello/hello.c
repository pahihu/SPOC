...
int main(int argc, char**argv)
{
  ...
  else
  {
    int arg;
    int i;
    fprintf(f,"#ifndef __hello_INCLUDES__\n");
    fprintf(f,"#define __hello_INCLUDES__\n");
...
{
  void *FP=NULL;
  tSF_P_Main_hello *MAINFP=(tSF_P_Main_hello *)malloc(sizeof(tSF_P_Main_hello));
  tTask main_t;
