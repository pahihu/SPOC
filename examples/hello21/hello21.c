...
struct SF_P_so_write_real32_wreal32
{
  tHeader _Header;
  void *Chain;
  CHAN *Param0;
  ...
  INT Param3;
  INT Param4;
  char WS[WS_P_so_write_real32_wreal32];
};
...
typedef struct SF_P_Main_hello21 tSF_P_Main_hello21;
void P_Main_hello21 (tSF_P_Main_hello21 *FP);
struct SF_P_Main_hello21
{
  tHeader _Header;
  void *Chain;
  CHAN *fs_495;
  CHAN *ts_496;
  USER h_500[SIZEUSER(16)];
  union
  {
    tSF_P_so_write_string_nl_wstring _C0;
    tSF_P_so_write_real32_wreal32 _C1;
    tSF_P_so_write_nl_wstring _C2;
...
int main(int argc, char**argv)
{
  ...
  else
  {
    int arg;
    int i;
    fprintf(f,"#ifndef __hello21_INCLUDES__\n");
    fprintf(f,"#define __hello21_INCLUDES__\n");
...
{
  void *FP=NULL;
  tSF_P_Main_hello21 *MAINFP=(tSF_P_Main_hello21 *)malloc(sizeof(tSF_P_Main_hello21));
  tTask main_t;
...
MAINFP->ts_496=&ts;
  ...
  STARTP(&main_t,P_Main_hello21,MAINFP,"P_Main_hello21",LowPriority);
...
#line   12 "hello21.occ"
          {
#line   12 "hello21.occ"
            static BYTE TMP[10] = {72,101,108,108,111,32,121,97,108,108};
#line   12 "hello21.occ"
            _V0_501 = TMP;
#line   12 "hello21.occ"
          }
#line   12 "hello21.occ"
          ASSIGN(((BYTE*)(((BYTE*)FP->h_500)+0)),_V0_501,(10*sizeof(BYTE))); 
#line   12 "hello21.occ"
        }
#line   13 "hello21.occ"
        *((REAL32*)(((BYTE*)FP->h_500)+12)) = 4.47e+01; 
#line   14 "hello21.occ"
        FP->_U0._C0.Param0=FP->fs_495;
#line   14 "hello21.occ"
        FP->_U0._C0.Param1=FP->ts_496;
#line   14 "hello21.occ"
        FP->_U0._C0.Param2_Dim0=10;
#line   14 "hello21.occ"
        FP->_U0._C0.Param2= (BYTE*)((BYTE*)(((BYTE*)FP->h_500)+0));
#line   14 "hello21.occ"
        FP->_U0._C0.Chain = NULL;
#line   14 "hello21.occ"
        CALL(P_so_write_string_nl_wstring,&FP->_U0._C0,1,"P_so_write_string_nl_wstring");
#line   14 "hello21.occ"
      CASE(1):  
#line   15 "hello21.occ"
        FP->_U0._C1.Param0=FP->fs_495;
#line   15 "hello21.occ"
        FP->_U0._C1.Param1=FP->ts_496;
#line   15 "hello21.occ"
        FP->_U0._C1.Param2=*((REAL32*)(((BYTE*)FP->h_500)+12));
#line   15 "hello21.occ"
        FP->_U0._C1.Param3=10;
#line   15 "hello21.occ"
        FP->_U0._C1.Param4=10;
#line   15 "hello21.occ"
        FP->_U0._C1.Chain = NULL;
#line   15 "hello21.occ"
        CALL(P_so_write_real32_wreal32,&FP->_U0._C1,2,"P_so_write_real32_wreal32");
#line   15 "hello21.occ"
      CASE(2):  
#line   16 "hello21.occ"
        FP->_U0._C2.Param0=FP->fs_495;
#line   16 "hello21.occ"
        FP->_U0._C2.Param1=FP->ts_496;
#line   16 "hello21.occ"
        FP->_U0._C2.Chain = NULL;
#line   16 "hello21.occ"
        CALL(P_so_write_nl_wstring,&FP->_U0._C2,3,"P_so_write_nl_wstring");
#line   16 "hello21.occ"
      CASE(3):  
#line   17 "hello21.occ"
