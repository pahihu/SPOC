...
typedef struct SF_P_Main_t tSF_P_Main_t;
void P_Main_t (tSF_P_Main_t *FP);
struct SF_P_Main_t
{
  tHeader _Header;
  void *Chain;
...
int main(int argc, char**argv)
{
  ...
  else
  {
    int arg;
    int i;
    fprintf(f,"#ifndef __t_INCLUDES__\n");
    fprintf(f,"#define __t_INCLUDES__\n");
...
{
  void *FP=NULL;
  tSF_P_Main_t *MAINFP=(tSF_P_Main_t *)malloc(sizeof(tSF_P_Main_t));
  tTask main_t;
...
MAINFP->ts_496=&ts;
  ...
  STARTP(&main_t,P_Main_t,MAINFP,"P_Main_t",LowPriority);
...
#line  112 "t.occ"
          ASSIGN(FP->h__s_498,_V0_500,(10*sizeof(BYTE))); 
#line  112 "t.occ"
        }
#line  113 "t.occ"
        FP->h__f_499 = 4.47e+01; 
#line  114 "t.occ"
...
#line  114 "t.occ"
        FP->_U0._C0.Param2= (BYTE*)FP->h__s_498;
#line  114 "t.occ"
